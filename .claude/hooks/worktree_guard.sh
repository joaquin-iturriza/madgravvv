...
# the first edit of trunk code on `trunk`. It injects a reminder and lets the edit
...
msg="Worktree reminder: editing trunk file directly on trunk. Per the git workflow, new experiment/feature work should go in a worktree (git worktree add worktrees/wt-<feat> -b <feat> trunk). If this is a quick standalone edit, proceed; otherwise create a worktree first."
